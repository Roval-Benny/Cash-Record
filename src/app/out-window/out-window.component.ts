...
@Component({
  selector: 'app-out-window',
  templateUrl: './out-window.component.html',
  styleUrls: ['./out-window.component.css']
})
export class OutWindowComponent implements OnInit {
  constructor(private ds:DataService,private rs:Router) { }
  public dateValue: Object = new Date();
  entry:Entry = new Entry(0,new Date(),'',0,false,0)
  Entries:Array<Entry> = []
  balance:number=0
